...
<ul class="comments">
    <li>
        ...
        <p class="small"><a rel="nofollow">${comment.userName}</a> ${_res.on} ${comment.commTime?string("yyyy-MM-dd HH:mm")}</p>
    </li>
</ul>
</#list>
        ...
        <div class="comments-wrapper">
            <div class="reply">
                ...
                <p class="comment-write">
                    ...
                    <textarea class="txpCommentInputMessage" rows="15" cols="45" name="userComment" id="message" required></textarea>
                </p>
                <div class="input-group">
                    <p>
                        <label for="name">${_res.name}</label>
                        <input type="text" id="name" class="comment_name_input" size="25" name="userName" required>
                    </p>
                    <p>
