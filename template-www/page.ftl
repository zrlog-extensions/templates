    ...
    <div class="container mx-auto px-4 md:px-6">
        <div class="flex flex-col lg:flex-row gap-8">
            <main class="lg:w-2/3 w-full space-y-6">
                ...
                <#if data?has_content>
                    <#if tipsType?has_content>
                        <div class="bg-white dark:bg-gray-900 shadow rounded-lg p-6">
                            <h3 class="text-xl dark:text-gray-200 font-semibold text-gray-800 mb-2">${tipsType}目录：${tipsName}</h3>
                        ...
                        <#list data.rows as log>
                            <article class="bg-white dark:text-gray-200 dark:bg-gray-900 shadow rounded-lg p-6 markdown-body space-y-4">
                                ...
                                <#if log.thumbnail?has_content>
                                    <img
                                            class="w-full h-auto max-h-60 object-cover rounded-lg border border-gray-200"
              ...
              <span class="category">
                <a href="${log.typeUrl}" class="text-blue-600 hover:underline">${log.typeName}</a>
              </span>
                                        <span>/</span>
